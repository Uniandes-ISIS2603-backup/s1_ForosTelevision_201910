...
public class ProductoraLogicTest {

    @Inject
    private ProduccionPersistence persitence;
    @Inject
    private ProductoraLogic logic;
    ...
    public static JavaArchive createDeployment() {
        return ShrinkWrap.create(JavaArchive.class)
                ...
                .addPackage(ProductoraLogic.class.getPackage())
    ...
    /**
     * Prueba para crear un recurso Productora..
     */
    @Test
    public void createProductoraTest() throws BusinessLogicException {
        PodamFactory factory = new PodamFactoryImpl();
        ProductoraEntity newEntity = factory.manufacturePojo(ProductoraEntity.class);
        ProductoraEntity result = logic.crearProductora(newEntity);
